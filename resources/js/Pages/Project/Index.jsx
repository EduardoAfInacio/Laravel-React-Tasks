              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  {projects.data.map((project) => (
                    <tr className="bg-white dark:bg-gray-800 border-b dark:border-gray-700" key={project.id}>
                      ...
                      <td className="px-3 py-2">
                        <span className={"px-2 py-1 rounded-lg text-white " + PROJECT_STATUS_CLASS_MAP[project.status]}>
